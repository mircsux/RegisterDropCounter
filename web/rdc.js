/* Register Drop Counter 2.32.0 — same integer-cent drop math as Windows / iPhone / Android / C23. */
(function () {
  "use strict";
  ...
  var SUGGESTED_FONTS = [
    ...
    "Georgia", "Cambria", "Bahnschrift", "Consolas", "Courier New",
    "Microsoft YaHei", "Microsoft JhengHei", "Malgun Gothic", "Yu Gothic",
    "Nirmala UI", "Leelawadee UI", "Segoe UI Emoji", "Segoe UI Symbol"
  ];
  var LEGACY_FONTS = {
    segoe: "Segoe UI", calibri: "Calibri", candara: "Candara", verdana: "Verdana",
    tahoma: "Tahoma", georgia: "Georgia", cambria: "Cambria", bahnschrift: "Bahnschrift",
    consolas: "Consolas", courier: "Courier New"
  };
  function cleanFont(raw) {
    var name = String(raw == null ? "" : raw).replace(/[\r\n\t]/g, " ").replace(/^\s+|\s+$/g, "").replace(/\s+/g, " ");
    if (LEGACY_FONTS[name]) name = LEGACY_FONTS[name];
  ...
  function aboutHtml() {
    return '<article class="card panel"><header class="card-h" style="display:block;padding:20px 24px"><p style="margin:0;font-size:12px;opacity:.7">Designed by Ronald Robbins Jr and SuperGrok</p><h2 style="margin:4px 0 0;font-size:24px">Register Drop Counter</h2><p style="margin:8px 0 0;opacity:.85">Version ' + VERSION + " (" + RELEASE + ")</p></header><div class='body'>" +
      ...
      "<p>v2.32.0  Help holds History, Stats for Nerds, and About. Stats lists the full History ledger.</p>" +
